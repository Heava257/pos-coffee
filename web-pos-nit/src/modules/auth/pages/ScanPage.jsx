...
import { setAcccessToken, setProfile } from "@/app/store/profile.store";
    ...
    const handleScan = async () => {
        ...
        try {
            ...
            if (res && res.access_token) {
                const { setGuestToken, setGuestProfile, setGuestPermission } = await import("@/app/store/profile.store");
