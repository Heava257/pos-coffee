        ...
        <MainPage loading={state.loading}>
            ...
            <div style={{ marginBottom: 24 }}>
                <Row gutter={[16, 16]}>
                    <Col xs={12} sm={12} md={6}>
                        <div className="op-mini-card" style={{ padding: isMobile ? "15px" : "20px" }}>
                    ...
                    <Col xs={12} sm={12} md={6}>
                        <div className="op-mini-card" style={{ padding: isMobile ? "15px" : "20px" }}>
                            <div style={{ color: "#64748b", fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: '0.5px' }}>{t.outstanding_balance}</div>
            ...
            {isMobile ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    {state.list.map((item) => (
                        <div key={item.id} className="op-mini-card" style={{ padding: '16px' }}>
                            ...
                            {(state.scanFilterId ? state.purchaseDetails.filter(d => d.id === state.scanFilterId) : state.purchaseDetails).map((item, index) => {
                                ...
                                return (
                                    <div key={item.id} style={{ 
                                        ...
                                        borderRadius: '16px', 
                                        padding: '16px', 
                                        border: isOver ? '2px solid #ef4444' : '1.5px solid var(--theme-dark-green)',
