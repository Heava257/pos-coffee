...
import { formatDateClient, formatDateServer, isPermission, request } from "@/shared/utils/helper";
...
import PrintInvoice from "@/modules/pos/components/PrintInvoice";
      ...
      {canSeeAllReports && (
        <Row gutter={[12, 12]} style={{ marginBottom: 20 }}>
          ...
          <Col xs={24} sm={12} lg={4}>
            <div className="op-mini-card" style={{
              padding: '16px 12px',
              display: 'flex',
          ...
          <Col xs={24} sm={12} lg={4}>
            <div className="op-mini-card" style={{
              ...
              <div style={{ fontSize: 24, fontWeight: 800, color: '#1e293b' }}>${(Number(summary.total_amount || 0) - Number(summary.total_expense || 0)).toLocaleString()}</div>
              <div style={{ fontSize: 13, color: '#64748b', fontWeight: 500 }}>{t.net_profit}</div>
            </div>
          </Col>
          {/* Top Selling Card */}
          <Col xs={24} sm={12} lg={4}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 20 }}>
          <div style={{
            ...
            <button
              ...
              className={`op-tab-btn ${state.activeTab === "1" ? "active" : ""}`}
            >
              <ClockCircleOutlined /> {t.tab_today}
            </button>
            <button
              onClick={() => setState(prev => ({ ...prev, activeTab: "2" }))}
              className={`op-tab-btn ${state.activeTab === "2" ? "active" : ""}`}
            >
