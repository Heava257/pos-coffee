...
import { getIconForCategory, getColorForCategory } from "@/shared/utils/helper";
import { Config } from "@/shared/utils/config";
import { getPrinterSettings } from "@/app/store/printer.store";
...
import { useHeldOrdersStore } from "@/app/store/heldOrdersStore";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            className="pos-search-shift-container"
            style={{
              display: "flex",
              alignItems: "center",
              flexWrap: "wrap",
