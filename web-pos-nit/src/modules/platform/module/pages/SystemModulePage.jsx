...
import { useProfileStore, broadcastRefresh } from "@/app/store/profileStore";
...
const SystemModulePage = () => {
    ...
    return (
        <div style={{ padding: '12px 16px', background: 'transparent', height: '100vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
