    ...
    return (
        <MainPage loading={state.loading}>
                ...
                <Row gutter={[20, 20]}>
                    <Col xs={24} sm={12} lg={6}>
                        <Card bordered={false} style={{ 
                            ...
                            <Statistic 
                                title={<span style={{ color: 'rgba(255,255,255,0.8)', fontSize: 13, fontWeight: 700 }}>{t.available_products}</span>}
                    ...
                    <Col xs={24} sm={12} lg={6}>
                        <Card bordered={false} style={{ 
                            ...
                            <Statistic 
                                title={<span style={{ color: lowStockProducts > 0 ? '#fff' : COLORS.secondary, fontSize: 13, fontWeight: 700 }}>{t.product_alerts}</span>}
            ...
            <style>{`
                ...
                .premium-tabs .ant-tabs-tab-active .ant-tabs-tab-btn { color: ${COLORS.primary} !important; }
                .premium-tabs .ant-tabs-ink-bar { background: ${COLORS.primary} !important; height: 3px !important; }
