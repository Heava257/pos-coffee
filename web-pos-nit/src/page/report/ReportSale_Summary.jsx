      ...
      <div ref={reportRef}>
        ...
        <Row gutter={[24, 24]} style={{ marginBottom: "32px" }}>
          <Col xs={24} sm={12} lg={6}>
            <Card bordered={false} style={{ borderRadius: 24, background: COLORS.primary, color: '#fff', overflow: 'hidden', position: 'relative' }}>
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card bordered={false} style={{ borderRadius: 24, boxShadow: '0 4px 15px rgba(0,0,0,0.03)', border: '1px solid #f1f5f9' }}>
              <Statistic 
